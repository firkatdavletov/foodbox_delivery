...
interface CatalogProductVariantRepository {
    ...
    fun findAllActiveByProductId(productId: UUID): List<CatalogProductVariant>
    fun findAllByProductIds(productIds: Collection<UUID>): List<CatalogProductVariant>
    fun findAllActiveByProductIds(productIds: Collection<UUID>): List<CatalogProductVariant>
